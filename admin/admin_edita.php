	...
	if (!isset($_GET['id_evento'] ))  {
		...
		echo "
			<div 'Alerta'> 
				...
				<a href='cerrarSesion.php' id='close'> Cerrar sesi&Atilde;&sup3;n</a>
			</div>
		";	
return;	
	}
...
<!--[if gt IE 8]><!--> <html lang="es" class="no-js"> <!--<![endif]-->
    <head>
        <title>Tu Foto Con el G&Atilde;&frac14;ero.com</title>
            ...
            <div class="contenedor-panel"><!-- Columna derecha (dashboard) -->
                <div id="update_evento">
                    <form action="edita.php" method="post" accept-charset="utf-8" name="evento_edita" id="evento_edita" enctype="multipart/form-data">
                        <fieldset>                            
                            <legend>Formulario de Edici&oacute;n de Eventos:</legend>
                            
                            	<label class="title">T&iacute;tulo-Nombre del Evento</label>                            
                            	...
                            	<label class="title">Selecciona la fecha del Evento</label>
                                	...
                                	<input type="text" name="date" id="date"   value="<?php echo $filaEvento->fecha; ?>" />
                            		</div>
                            ...
                            <hr>
                                ...
                                <input id="submit_files" type="submit" name="submit_files" value="Agregar + Im&Atilde;&iexcl;genes">
                            </div>
                            <?php                            
                ...
                </div><!-- Formulario de B&Atilde;&ordm;squeda -->
