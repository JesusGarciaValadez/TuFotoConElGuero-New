...
<nav>
  <ul>
    ...
    <li><a href="admin_principal.php">Agregar evento </a></li>
...
<div class="galeria">
   ...
   $lenght= strlen($filasCategorias['evento']);
   
   
   				echo "<label class='lblevento'>Evento: <span> ". substr($filasCategorias['evento'],0,($lenght < 120) ? $lenght:120 ) ."</span></label><br>" ;
   				$lenght= strlen($filasCategorias['descripcion']);
   				echo "<label class='lbldescripcion'>Descripcion:  <span>". substr($filasCategorias['descripcion'],0,($lenght < 250) ? $lenght:250 )."</span></label></br>" ;
                ...
                while($filas = $resultado->fetch_array(MYSQLI_ASSOC)) {
                    ...
                    if (file_exists($rutaimg)){                    	
                        ...
                        echo'<img  src="../imagenes/'.$filas['directorio'].'/thumb'.$filas['archivo'].'"/>';
                    }                    
            ...
            echo "|";
            echo "<a href='admin_edita.php?id_evento=".(string)$filasCategorias['id']."'> Editar </a>";
            echo "|";          
