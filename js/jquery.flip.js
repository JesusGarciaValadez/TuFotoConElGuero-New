...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: "transparent",//acceptHexColor(settings.color) || "#999",
        ...
        flipObj = {
            width: $this.width(),
            height: $this.height(),
            bgColor: "transparent",//acceptHexColor(settings.bgColor) || $this.css("background-color"),
            fontSize: $this.css("font-size") || "12px",
            direction: settings.direction || "tb",
            toColor: "transparent",//acceptHexColor(settings.color) || "#999",
            speed: settings.speed || 500,
            top: $this.offset().top,
