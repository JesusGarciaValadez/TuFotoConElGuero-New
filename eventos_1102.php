...
<html lang="es">
	<head>
        ...
        <link href="<?php echo $g->PATH_CSS; ?>jquery.carousel-lightbox.css" rel="stylesheet" />
        <!--link href="<?php echo $g->PATH_CSS; ?>jquery.lightbox.css" rel="stylesheet" /-->   
        ...
        <script type="text/javascript" src="<?php echo $g->PATH_JS; ?>jquery.carousel-lightbox.js"></script>
        <!--script type="text/javascript" src="<?php echo $g->PATH_JS; ?>jquery.lightbox.js"></script-->
