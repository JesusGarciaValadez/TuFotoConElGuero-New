...
function PrintEvento( $id, $foto)
	...
	function dibujaCeldaTop($evento,$id,$fecha,$rutaimg) {
	...
	function dibujaCelda($evento,$id,$fecha,$rutaimg) {
		echo "<div class='tabla-col' >";
			echo "<a href='eventos.php?id=".$evento."&foto=".$id."' title = '".$fecha."'>";
			echo "<img class='galeria-lightbox' src='".$rutaimg."' alt='".$fecha."'  title = '".$fecha."'></a>";
		echo "</div>";
	}
						 ...
						 switch($aux) {
							case 0:								
									echo "<div class='tabla-row' >";	
										$this->dibujaCeldaTop($rowImg->evento,$rowImg->id, $fecha, $rutaimg);
										$openrow=true;
										break;
							case 1:
									$this->dibujaCeldaTop($rowImg->evento,$rowImg->id, $fecha, $rutaimg);
