...
function generaListaImgShadow( $evento,$fecha,$imgagregada)
	...
	function dibujaCelda($evento,$id,$fecha,$rutaimg,$rutathumb, $class='img-width') {
						...
						if ($openrow ) { 			//si esta bierta la fila
							...
							if ($indexCols <= 3 ) { //agregamos una celda mas
									...
									echo "<span>".$rowEvento->fecha."</span>";  
						 			$this->dibujaCelda($rowEvento->evento,$rowEvento->id, $rowEvento->fecha, $rutaimg,$rutathumb,$estilo);
						 			echo "</div >";
						 	}
