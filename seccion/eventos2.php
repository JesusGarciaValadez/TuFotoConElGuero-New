...
class Eventos extends Model {
    ...
    function __construct() {
        ...
        if ($this->db->error) {
            ...
            echo "No se puede establecer conexi√≥n con la base de datos";
            exit;
        }
    }
...
function PrintEventoxFechaGenerica($anio, $mes) {
    ...
    function dibujaCelda($evento, $id, $fecha, $rutaimg, $rutathumb, $class = 'img-width', $descripcion = 'Sin DescripciÛn') {
        $meses = array(
            "Enero",
            "Febrero",
            "Marzo",
...
<div class="Img-foto">';
    ...
    function dibujaCeldaConLinks($evento, $id, $fecha, $rutaimg, $rutathumb, $class = 'img-width', $descripcion = 'Sin DescripciÛn') {
        $meses = array(
            "Enero",
            "Febrero",
            "Marzo",
    ...
    function PrintEventos() {
        ...
        if ($id != 0) {
            ...
            if ($municipio != 0) {
                ...
                //Cuando  se le pasa el aÒo (anio), mes y un evento (id) en especifico, se lanza desde mas eventos
